    ...
    componentWillMount = (updatedPageNumber = "", query) => {
        ...
        .catch(error => {
            if(axios.isCancel(error) || error){
                this.setState({
                    loading:false,
                    message: "Failed to fecth the data"
                })
            }
        })
    }
            ...
            <div className="results-container">
                {Results.map((result, index) => {
                    return(
                        ...
                        onClick={this.addToFavourite.bind(this, index, result.previewUrl, result.artistName, result.artworkUrl100)}
                        >
                            add To Favourite
                        </Button>
                        </div>
...
render(){
    ...
    // hanbdling previous and next page
